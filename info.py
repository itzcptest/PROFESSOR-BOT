...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6880594191').split()]
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/c6a6a07aebcfe756e4160.jpg")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>Hey {mention}\n\n👋📓 Fɪʟᴍ Nᴀᴍᴇ :\n<u>{file_name}</u>\n\n▫️ Sɪᴢᴇ : <code>{file_size}</code>\n\n🔘 Uᴘʟᴏᴀᴅ Bʏ :\n<blockquote>#FilmZone | @FilmZone_Official</blockquote></b>")
